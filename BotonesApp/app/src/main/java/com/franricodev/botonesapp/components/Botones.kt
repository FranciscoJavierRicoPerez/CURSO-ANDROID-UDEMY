package com.franricodev.botonesapp.components
...
fun BotonSwitch() {
    ...
    Switch(
        ...
        colors = SwitchDefaults.colors(
            ...
            uncheckedThumbColor = Color.Blue, // Thum es la bola
            uncheckedTrackColor = Color.Magenta  // Track es el fondo
        )
    )
}
