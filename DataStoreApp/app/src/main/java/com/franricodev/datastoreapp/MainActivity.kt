package com.franricodev.datastoreapp
...
import com.franricodev.datastoreapp.ui.theme.DataStoreAppTheme
import kotlinx.coroutines.launch

/**
 * LOS DATASTORE SON INTERESANTES PARA PODER GUARDAR CONFIGURACIONES
 * PARECIDAD A LAS COOKIES DEL NAVEGADOR
 *
 * - Indicar MODO OSCURO etc...
 *
 */
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            DataStoreAppTheme(darkTheme = darkMode.value) {
...
fun Greeting(darkModeStore: StoreDarkMode, darkMode: Boolean) {
    ...
    Column(
        ...
        var email by rememberSaveable { mutableStateOf("") } // rememberSaveable -> para que no se pieda informacion si se gira la pantalla del telefono
